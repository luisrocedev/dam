...
class ProgressScreen(tk.Frame):
    ...
    def start_extraction(self):
        ...
        try:
            ...
            # Launch main.py after extraction
            self.parent.after(1000, self.launch_main_py)  # Delay to allow user to see the completion message
    ...
    def launch_main_py(self):
        ...
        # Optionally, close the installer after launching main.py
        self.parent.destroy()
