...
print("1.-Introduce un nuevo "+tablas[int(opcion)]+":")                     # Imprimo el menú CRUD y este sí que es estático
...
elif opcionnivel2 == "2":                                                   # en el caso de que sea un listado
    print("Vamos a listar ",tablas[int(opcion)])                            # Aviso de la operación que voy a realizar
